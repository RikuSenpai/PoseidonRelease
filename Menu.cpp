...
void SaveCallbk()
{
	...
	case 2:
		...
		break;
	case 3:
		GUI.SaveWindowState(&Menu::Window, "Alpha.cfg");
		break;
	case 4:
		GUI.SaveWindowState(&Menu::Window, "Bravo.cfg");
		break;
	case 5:
		GUI.SaveWindowState(&Menu::Window, "Charlie.cfg");
		break;
	case 6:
		GUI.SaveWindowState(&Menu::Window, "Delta.cfg");
		break;
	case 7:
		GUI.SaveWindowState(&Menu::Window, "Foxtro.cfg");
		break;
	}
}
...
void LoadCallbk()
{
	...
	case 2:
		...
		break;
	case 3:
		GUI.LoadWindowState(&Menu::Window, "Alpha.cfg");
		break;
	case 4:
		GUI.LoadWindowState(&Menu::Window, "Bravo.cfg");
		break;
	case 5:
		GUI.LoadWindowState(&Menu::Window, "Charlie.cfg");
		break;
	case 6:
		GUI.LoadWindowState(&Menu::Window, "Delta.cfg");
		break;
	case 7:
		GUI.LoadWindowState(&Menu::Window, "Foxtro.cfg");
		break;
	}
}
...
{
	DoUnload = true;
	Interfaces::Engine->ExecuteClientCmd("quit");
}
...
#pragma region Bottom Buttons
	...
	ConfigBox.AddItem("Alpha");
	ConfigBox.AddItem("Bravo");
	ConfigBox.AddItem("Charlie");
	ConfigBox.AddItem("Delta");
	ConfigBox.AddItem("Foxtro");
	...
	forceupdate.SetCallback(KnifeApplyCallbk);
	forceupdate.SetSize(112, 200);
	forceupdate.SetPosition(10, 490);

	UnloadButton.SetText("Unload Cheat");
	UnloadButton.SetCallback(UnLoadCallbk);
	UnloadButton.SetSize(112, 200);
	UnloadButton.SetPosition(10, 490);
	...
	SettingsTab.RegisterControl(&forceupdate);
...
#pragma region Accuracy
	...
	AdvancedResolver.SetFileId("acc_nospread");
	AccuracyGroup.PlaceCheckBox("No Spread Resolver", this, &AdvancedResolver);

	LBYCorrection.SetFileId("acc_lbycorrection");
	AccuracyGroup.PlaceCheckBox("LBY Correction", this, &LBYCorrection);

	extrapolation.SetFileId("acc_enginepred");
	AccuracyGroup.PlaceCheckBox("extrapolation", this, &extrapolation);

	QuickStop.SetFileId("acc_quickstop");
	AccuracyGroup.PlaceCheckBox("Quick Stop", this, &QuickStop);
...
#pragma region Target
	...
	TargetHitbox.AddItem("Head + Chest");
	...
	TargetGroup.PlaceOtherControl("Delay Shot", this, &delay_shot);

	/*hitbox_Head.SetFileId("hitbox_Head");
	TargetGroup.PlaceCheckBox("hitbox_Head", this, &hitbox_Head);

	hitbox_Neck.SetFileId("hitbox_Neck");
	TargetGroup.PlaceCheckBox("hitbox_Neck", this, &hitbox_Neck);

	hitbox_Chest.SetFileId("hitbox_Chest");
	TargetGroup.PlaceCheckBox("hitbox_Chest", this, &hitbox_Chest);

	hitbox_Stomach.SetFileId("hitbox_Stomach");
	TargetGroup.PlaceCheckBox("hitbox_Stomach", this, &hitbox_Stomach);
	
	hitbox_Arms.SetFileId("hitbox_Arms");
	TargetGroup.PlaceCheckBox("hitbox_Arms", this, &hitbox_Arms);

	hitbox_Legs.SetFileId("hitbox_Legs");
	TargetGroup.PlaceCheckBox("hitbox_Legs", this, &hitbox_Legs);

	hitbox_Feet.SetFileId("hitbox_Feet");
	TargetGroup.PlaceCheckBox("hitbox_Feet", this, &hitbox_Feet);


	bil.SetFileId("bil");
	TargetGroup.PlaceCheckBox("Baim If Lethal", this, &bil);*/
/*
	imdil.SetFileId("imdil");
	TargetGroup.PlaceCheckBox("Ignore Min Damage If Lethal", this, &imdil);
*/
	...
	TargetGroup.PlaceOtherControl("Yaw Resolver", this, &AimbotResolver);
...
#pragma region AntiAim
	...
	FakeYaw.AddItem("Off");
	FakeYaw.AddItem("Desync Simple");
	FakeYaw.AddItem("Desync Balance");
	FakeYaw.AddItem("Desync Nae Nae");
	FakeYaw.AddItem("Desync Jitter");
	FakeYaw.AddItem("Desync Manual (broken)");
	FakeYaw.AddItem("Desync Crooked");
	FakeYaw.AddItem("Desync Freestanding");
	AntiAimGroup.PlaceOtherControl("Desync Standing", this, &FakeYaw);

	MoveYawFake.SetFileId("movingfakeaa");
	MoveYawFake.AddItem("Off");
	MoveYawFake.AddItem("Desync Simple");
	MoveYawFake.AddItem("Desync Balance");
	MoveYawFake.AddItem("Desync Nae Nae");
	MoveYawFake.AddItem("Desync Jitter");
	MoveYawFake.AddItem("Desync Manual (broken)");
	MoveYawFake.AddItem("Desync Crooked");
	MoveYawFake.AddItem("Desync Freestanding");
	AntiAimGroup.PlaceOtherControl("Desync Moving", this, &MoveYawFake);
...
#pragma region Aimbot
	...
	TickModulation.SetBoundaries(0.1f, 12.f);
	...
	LegitAA.SetFileId("aim_legitaa");
	AimbotGroup.PlaceCheckBox("Legit AA", this, &LegitAA);
...
#pragma region Options
	...
	OptionsSkeleton2.SetFileId("opt_skel");
	BoxGroup.PlaceCheckBox("Skeleton", this, &OptionsSkeleton2);

	DrawMoney.SetFileId("opt_drawmoney");
	BoxGroup.PlaceCheckBox("Draw Money", this, &DrawMoney);
...
//	ChamsGroup.PlaceCheckBox("Opacity", this, &pLocalOpacity);
	...
	Indicators.SetFileId("opt_indicators");
	OptionsGroup.PlaceCheckBox("Indicators", this, &Indicators);

	cheatinfo.SetFileId("opt_cheatinfo");
	OptionsGroup.PlaceCheckBox("Info", this, &cheatinfo);

	InfoGroup.SetText("ESP 4");
	InfoGroup.SetPosition(526, 155);
	InfoGroup.SetSize(173, 155);
	RegisterControl(&InfoGroup);

	Ammo.SetFileId("opt_ammobar");
	InfoGroup.PlaceCheckBox("Ammo ESP", this, &Ammo);
...
#pragma region Other
	...
	OptionsGlow.SetFileId("opt_OptionsGlow");
	GlowGroup.PlaceCheckBox("Player Glow", this, &OptionsGlow);

	GlowZ.SetFileId("opt_glowz");
	GlowZ.SetBoundaries(0.f, 255.f);
	GlowZ.SetValue(255);
	GlowGroup.PlaceOtherControl("Glow Alpha", this, &GlowZ);

//	AimbotTarget.SetFileId("opt_aimbotselec");
//	GlowGroup.PlaceCheckBox("Aimbot Target", this, &AimbotTarget);

	DefuseWarning.SetFileId("opt_defusing");
	GlowGroup.PlaceCheckBox("Defuse Warning", this, &DefuseWarning);

	RenderGroup.SetText("ESP 3");
...
//	OptionsInfo2.SetFileId("opt_info");
//	RenderGroup.PlaceCheckBox("Info", this, &OptionsInfo2);

//	Grenades2.SetFileId("opt_gren");
//	RenderGroup.PlaceCheckBox("Grenades Prediction", this, &Grenades2);

	Walldmg.SetFileId("opt_wallbngindicator");
	RenderGroup.PlaceCheckBox("Wallbang Indicator", this, &Walldmg);
	...
	//ModelsGroup.SetPosition(265, 248);
	//ModelsGroup.SetSize(193, 430);
	//RegisterControl(&ModelsGroup);

	//ModelsKawaiiDesu.SetFileId("mdl_kawaiidesu");
	//ModelsGroup.PlaceOtherControl("Kawaii Desu", this, &ModelsKawaiiDesu);

	//ModelsKnife.SetFileId("mdl_knife");
	//ModelsKnife.AddItem("Off");
	//ModelsKnife.AddItem("Pickaxe");
	//ModelsKnife.AddItem("Baseball");
	//ModelsKnife.AddItem("Lightsaber");
	//ModelsKnife.AddItem("Kung Fu");
	//ModelsKnife.AddItem("Tridagger");
	//ModelsGroup.PlaceOtherControl("Knife", this, &ModelsKnife);

	//ModelsArms.SetFileId("mdl_arms");
	//ModelsArms.AddItem("Off");
	//ModelsArms.AddItem("Nanosuit");
	//ModelsArms.AddItem("Banana");
	//ModelsArms.AddItem("Alien");
	//ModelsArms.AddItem("Deadpool");
	//ModelsArms.AddItem("Hitler");
	//ModelsArms.AddItem("Helena");
	//ModelsArms.AddItem("Shepard");
	//ModelsArms.AddItem("Slickman");
	//ModelsGroup.PlaceOtherControl("Arms", this, &ModelsArms);

	//ModelsAK47.SetFileId("mdl_ak47");
	//ModelsAK47.AddItem("Off");
	//ModelsAK47.AddItem("AK47 1");
	//ModelsAK47.AddItem("AK47 2");
	//ModelsAK47.AddItem("Ethereal");
	//ModelsGroup.PlaceOtherControl("AK47", this, &ModelsAK47);

	//ModelsM4A4.SetFileId("mdl_m4a4");
	//ModelsM4A4.AddItem("Off");
	//ModelsM4A4.AddItem("M4A1-S 1");
	//ModelsM4A4.AddItem("Ethereal");
	//ModelsGroup.PlaceOtherControl("M4A4", this, &ModelsM4A4);

	//ModelsM4A1s.SetFileId("mdl_m4a1s");
	//ModelsM4A1s.AddItem("Off");
	//ModelsM4A1s.AddItem("M4A1-S 1");
	//ModelsM4A1s.AddItem("Ethereal");
	//ModelsGroup.PlaceOtherControl("M4A1-S", this, &ModelsM4A1s);

	//ModelsAWP.SetFileId("mdl_awp");
	//ModelsAWP.AddItem("Off");
	//ModelsAWP.AddItem("On");
	//ModelsGroup.PlaceOtherControl("AWP", this, &ModelsAWP);

	//ModelsDeagle.SetFileId("mdl_deagle");
	//ModelsDeagle.AddItem("Off");
	//ModelsDeagle.AddItem("On");
	//ModelsGroup.PlaceOtherControl("Deagle", this, &ModelsDeagle);
...
#pragma region Other
	...
	OtherGroup.PlaceCheckBox("Water Mark", this, &watermark);
...
#pragma region FakeLag
	...
	FakeLagTyp.AddItem("Adaptive - Aimware");
...
void CSettingsTab::Setup()
{
	...
	wpnhitchanceGroup.SetPosition(32 + 134, -15 - 8);
	wpnhitchanceGroup.SetSize(360, 360);
	...
	MinDMG.SetFileId("Minimum_Damage");
	wpnhitchanceGroup.PlaceCheckBox("Minimum Damage", this, &MinDMG);

	scoutmindmg.SetFileId("scout_mindmg");
	scoutmindmg.SetBoundaries(0, 100);
	scoutmindmg.SetValue(0);
	wpnhitchanceGroup.PlaceOtherControl("Scout", this, &scoutmindmg);

	AWPmindmg.SetFileId("awp_mindmg");
	AWPmindmg.SetBoundaries(0, 100);
	AWPmindmg.SetValue(0);
	wpnhitchanceGroup.PlaceOtherControl("AWP", this, &AWPmindmg);

	Automindmg.SetFileId("auto_mindmg");
	Automindmg.SetBoundaries(0, 100);
	Automindmg.SetValue(0);
	wpnhitchanceGroup.PlaceOtherControl("Auto", this, &Automindmg);

	Riflemindmg.SetFileId("rifle_mindmg");
	Riflemindmg.SetBoundaries(0, 100);
	Riflemindmg.SetValue(0);
	wpnhitchanceGroup.PlaceOtherControl("Rifle", this, &Riflemindmg);

	MPmindmg.SetFileId("mp_mindmg");
	MPmindmg.SetBoundaries(0, 100);
	MPmindmg.SetValue(0);
	wpnhitchanceGroup.PlaceOtherControl("MPS", this, &MPmindmg);

	Pistolmindmg.SetFileId("pistol_mindmg");
	Pistolmindmg.SetBoundaries(0, 100);
	Pistolmindmg.SetValue(0);
	wpnhitchanceGroup.PlaceOtherControl("Pistols", this, &Pistolmindmg);

	wpnmindmgGroup.SetPosition(408 + 124, -15 - 8);
	wpnmindmgGroup.SetSize(360, 190);
	wpnmindmgGroup.SetText("Key Binds");
	RegisterControl(&wpnmindmgGroup);

	minimalwalk.SetFileId("slowwalkonkeypress");
	wpnmindmgGroup.PlaceOtherControl("Slow Walk", this, &minimalwalk);

	AimbotBaimOnKey.SetFileId("baimonkeypress");
	wpnmindmgGroup.PlaceOtherControl("Body Aim", this, &AimbotBaimOnKey);

	ThirdPersonKeyBind.SetFileId("aa_thirdpersonKey");
	wpnmindmgGroup.PlaceOtherControl("Thirdperson Key", this, &ThirdPersonKeyBind);
