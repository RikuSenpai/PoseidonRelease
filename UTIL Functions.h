...
namespace GameUtils
{
	...
	bool IsVisible(IClientEntity* pLocal, IClientEntity* pEntityity, int BoneID);
	...
	int GetPlayerCompRank(IClientEntity* pEntityity);
...
Vector GetHitpointPosition(IClientEntity* pEntityity, int Hitbox, Vector *Point);

//bool GetBestPoint(IClientEntity* pEntityity, Hitbox* hitbox, Vector *point);

Vector GetHitboxPosition(IClientEntity* pEntityity, int Hitbox);

//Vector GetHitscan(IClientEntity* pEntityity, int Hitbox);
