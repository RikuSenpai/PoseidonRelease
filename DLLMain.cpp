...
#define me -2043748160
#define mvstyk -663775572
#define stiz 1922811539 
#define classic1337 -532606730
...
int InitialThread()
{
	//Utilities::OpenConsole("poseidon");
	...
	//Interfaces::gameUI->messageBox(" Poseidon.cc beta ", "Rage Cheat created by Classic1337");
